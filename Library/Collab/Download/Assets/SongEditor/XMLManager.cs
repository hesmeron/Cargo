...
public class XMLManager
{
    ...
    public void SaveSong(Song song)
    {
        ...
        string filename = Application.dataPath + "Resources/XMLLibrary/" + song.title + ".xml";
    ...
    public Song LoadSong(string title)
    {
        ...
        XmlSerializer xmlSerilizer = new XmlSerializer(typeof(Song));
        FileStream stream = new FileStream(Application.dataPath + "/XMLLibrary/" + title + ".xml", FileMode.Open);
        Song song = (Song) xmlSerilizer.Deserialize(stream);
        stream.Close();
        return song;
    }
}
